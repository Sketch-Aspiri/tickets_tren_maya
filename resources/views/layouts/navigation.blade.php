...
<div x-cloak x-show="sidebarOpen" x-on:click="sidebarOpen = false" class="fixed inset-0 z-30 bg-brand-green-dark/60 lg:hidden" aria-hidden="true"></div>
...
>
    <div class="flex items-center justify-between px-4 py-3">
        ...
        <button type="button" x-on:click="sidebarOpen = false" class="inline-flex h-11 w-11 items-center justify-center rounded-md text-brand-green hover:bg-brand-mist focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-teal lg:hidden" aria-label="{{ __('common.nav.close_menu') }}">
